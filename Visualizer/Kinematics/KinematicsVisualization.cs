    ...
    class KinematicsVisualization : IVisualization
    {
        ...
        public CommandSet<VisualizerControl.Visualizer> Initialization()
        {
            ...
            foreach (var connector in connectorMap)
            {
                ...
                var obj = new ObjectPrototype(new VisualizerControl.Shapes.Helix3D(1, new Geometry.Geometry2D.Point(0, 0), 1, nTurns), 
            ...
            set.AddCommand(new MoveCamera(new DongUtility.Vector(-3.85e8, 0, 1e7), new DongUtility.Vector(0, 0, -1), new DongUtility.Vector(0, 1, 0)));
